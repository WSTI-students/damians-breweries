...
ingredients = [{ name: 'Słód pilzneński', category: 'malt' }, { name: 'Słód Pale Ale', category: 'malt' }, { name: 'Słód monachijski', category: 'malt' }, { name: 'Marynka', category: 'hopp' }, { name: 'Curacao', category: 'addition' }, { name: 'Simcoe', category: 'hopp' }]
